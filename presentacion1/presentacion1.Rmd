...
***
## The general objective of Line 2 is to analyse and identify the main factors and consequences associated with the emergence of conflict and social cohesion at the interpersonal and intergroup levels.
***
---

**Specific objectives:**

1. Identify and explore how individual characteristics and interpersonal dynamics have an impact on how people deal with conflictive situations.

2. Analyze the structure of social networks (size and diversity) from a longitudinal perspective as well as their relationship with attitudes and beliefs.

3. Assess current levels of intergroup contact, friendship across social class and segregation and their relation with psychological factors that are relevant for social cohesion.

4. Assess antecedents and processes (mechanisms) that guide the development of inter- group friendships across social class, gender, ethnicity and groups of immigrants.

5.  Analyse the changes we have observed in expressions of distributive preferences, and how these differ between particular social groups and elites, in cooperation with Line 3. 

6. Identify student, teacher, family and school level characteristics that are related to cohesive citizenship, particularly by studying topics such as participation, citizenship education and prosocial behaviour
...
|    Actividad                                                                  |    Fecha          |
|:-------------------------------------------------------------------------------|:-----------------|
|    Entrega de Base de datos ELSOC 2018 (Corte   Transversal)                  |    17 de Abril    |
|    Entrega   de Documentación   ELSOC 2018 (Corte Transversal)                |    17 de Abril    |
